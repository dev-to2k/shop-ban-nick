...
import { useAdminAccountsContext } from '@/lib/admin-accounts-context';
...
export default function AdminGameAccountsClient() {
                ...
                <CardContent className="p-3 flex items-center justify-between">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      <Badge variant={statusColors[acc.status] as 'default' | 'secondary' | 'destructive' | 'outline'}>{acc.status}</Badge>
                    </div>
