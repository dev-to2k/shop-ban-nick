...
import { useAppStore, useBreadcrumb, api, queryKeys, useCurrencyInput } from '@shop-ban-nick/shared-web';
...
export function ProfileWalletPage() {
  ...
  useEffect(() => {
    setBreadcrumb([{ label: 'Trang chủ', href: '/' }, { label: 'Tài khoản', href: '/profile' }, { label: 'Ví của tôi' }]);
